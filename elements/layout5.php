...
class News_layout5 extends Widget_Base{
    ...
    protected function render( $instance = [] ){
    	...
    	?>
		<div class="layout la-five">
            <div class="news_grid--col2">
           
            <?php while($query->have_posts()): $query->the_post(); ?>
                <div class="news-item">
                    <div class="news-item--thumb">
                        <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('thumbnail_medium'); ?></a>
                    </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new News_layout5);