...
class News_layout3 extends Widget_Base{
    ...
    protected function render( $instance = [] ){
        ...
        $d = 0;
    	?>
        <div class="layout la-three">
                <?php while($query->have_posts()): $query->the_post(); ?>
                <div class="news-item <?php echo $d == 0 ? 'news__big': 'news__small'; ?>">
...
Plugin::instance()->widgets_manager->register_widget_type( new News_layout3);