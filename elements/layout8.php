...
class Layout8 extends Widget_Base{
    ...
    protected function render( $instance = [] ){
    	...
    	?>
		<div class="section_bg--black wrapper">
			<div class="container">
				<div class="layout la-eight">
					<h2 class="layout-title">फिचर</h2>
...
Plugin::instance()->widgets_manager->register_widget_type( new Layout8);
